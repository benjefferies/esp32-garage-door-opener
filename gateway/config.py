...
# XC6206 is ~250 mA. Default ~20 dBm TX is 280–350 mA and browns out.
# 12 dBm is a bit more range for Google Wifi; drop to 8 if SoftAP dies.
WIFI_TXPOWER_DBM = 12
...
AP_IP = "192.168.4.1"
AP_DNS = AP_IP  # Hijack DNS so the phone captive sheet loads this portal
